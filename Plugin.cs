...
//                    player.SendInfoMessage($"[ GetInfoUtil ] by {Author} v{Version} please follow in Youtube and Discord");
...
//                    player.SendInfoMessage($"  [i:938] [c/66B2FF:DEFENSA:] [ {defense} ]");
//                    player.SendInfoMessage($"  [i:4080] [c/FFCC66:PAIS:] [ {playerCountry} ]");
//                });
